...
(function(Opal) {
  Opal.dynamic_require_severity = "error";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, s = nil, d = nil, b = nil, p = nil;

  Opal.add_stubs(['$require', '$attr_accessor', '$/', '$*', '$puts', '$+', '$to_s', '$name', '$type', '$judge', '$new', '$p', '$damage', '$atk', '$==', '$-', '$>', '$<', '$to_i', '$show_status', '$do', '$waza1']);
  self.$require("opal");
  (function($base, $super) {
    function $Type(){};
    var self = $Type = $klass($base, $super, 'Type', $Type);

    var def = self.$$proto, $scope = self.$$scope;

    self.$attr_accessor("name");

    return (def.$do = function(hp, atk, defence) {
      var self = this;
  ...
  (function($base, $super) {
    function $Gu(){};
    var self = $Gu = $klass($base, $super, 'Gu', $Gu);
  ...
  (function($base, $super) {
    function $Cho(){};
    var self = $Cho = $klass($base, $super, 'Cho', $Cho);
  ...
  (function($base, $super) {
    function $Pa(){};
    var self = $Pa = $klass($base, $super, 'Pa', $Pa);
  ...
  (function($base, $super) {
    function $Waza(){};
    var self = $Waza = $klass($base, $super, 'Waza', $Waza);

    var def = self.$$proto, $scope = self.$$scope;

    def.name = nil;
    self.$attr_accessor("name", "type");
    ...
    return (def.$do = function(m, e) {
      var self = this, wazatype = nil, entype = nil;

      self.$puts(m.$name().$to_s()['$+']("の")['$+'](self.name.$to_s())['$+']("!"));
      wazatype = self.$type().$name();
      entype = e.$type().$name();
      return self.state = self.$judge(self.$type().$name(), e.$type().$name());
    }, nil) && 'do';
  })(self, null);
  (function($base, $super) {
    function $Kirisaku(){};
    var self = $Kirisaku = $klass($base, $super, 'Kirisaku', $Kirisaku);
    ...
    def.$initialize = function() {
      ...
      self.name = "きりさく";
      return self.type = $scope.get('Cho').$new();
    };

    return (def.$do = TMP_1 = function(m, e) {
      var $a, self = this, $iter = TMP_1.$$p, $yield = $iter || nil;

      TMP_1.$$p = null;
      Opal.find_super_dispatcher(self, 'do', TMP_1, null).apply(self, [m, e]);
      if ((($a = (self.state)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$p("勝ち");
        self.$puts("攻撃力×2!");
        return e.$damage(m.$atk()['$*'](2));
      } else if ((($a = (self.state['$=='](false))) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$p("負け");
        return e.$damage(m.$atk()['$/'](2));
        } else {
        return self.$p("あいこ")
  ...
  (function($base, $super) {
    function $Knuckle(){};
    var self = $Knuckle = $klass($base, $super, 'Knuckle', $Knuckle);
    ...
    def.$initialize = function() {
      ...
      self.name = "ナックルパンチ";
      return self.type = $scope.get('Gu').$new();
    };

    return (def.$do = TMP_2 = function(m, e) {
      var $a, self = this, $iter = TMP_2.$$p, $yield = $iter || nil;

      TMP_2.$$p = null;
      Opal.find_super_dispatcher(self, 'do', TMP_2, null).apply(self, [m, e]);
      if ((($a = (self.state)) !== nil && (!$a.$$is_boolean || $a == true))) {
        self.$p("勝ち");
        self.$puts("攻撃力1/2!");
        return e.$damage(m.$atk()['$*'](2));
  ...
  (function($base, $super) {
    function $Henka(){};
    var self = $Henka = $klass($base, $super, 'Henka', $Henka);
  ...
  (function($base, $super) {
    ...
    def.def = def.hp = def.name = def.atk = def.type = def.status = nil;
    self.$attr_accessor("name", "hp", "atk", "def", "type", "type2", "waza1", "status");

    def.$initialize = function(name, hp, atk, defence, type) {
      var self = this;
    ...
    def.$damage = function(hp_damage) {
      var $a, self = this, damage = nil;

      damage = hp_damage['$-'](self.def);
      if ((($a = (damage['$>'](0))) !== nil && (!$a.$$is_boolean || $a == true))) {
        if ((($a = (self.hp['$<'](damage))) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$puts("死");
          self.status = "死";
          self.hp = 0;
          return false;};
        self.hp = self.hp['$-'](damage);
        self.$puts(self.name['$+']("に")['$+'](damage.$to_s())['$+']("のダメージ"));
        } else {
        self.$puts(self.name['$+']("に0のダメージ"))
      };
      return self.hp;
    };

    return (def.$show_status = function() {
      var self = this;

      self.$puts("-------");
      self.$puts("name:"['$+'](self.name));
      self.$puts("hp:"['$+'](self.hp.$to_s()));
      self.$puts("atk:"['$+'](self.atk.$to_s()));
      self.$puts("def:"['$+'](self.def.$to_s()));
      self.$puts("type:"['$+'](self.type.$name().$to_s()));
      self.$puts("status:"['$+'](self.status.$to_s()));
      return self.$puts("-------");
    }, nil) && 'show_status';
  })(self, null);
  (function($base, $super) {
    function $Slime(){};
    var self = $Slime = $klass($base, $super, 'Slime', $Slime);
    ...
    return (def.$initialize = function() {
      ...
      self.atk = 5;
      self.def = 5;
      self.type = $scope.get('Gu').$new();
      return self.waza1 = $scope.get('Knuckle').$new();
    }, nil) && 'initialize'
  })(self, $scope.get('Monster'));
  (function($base, $super) {
    function $SlimeBes(){};
    var self = $SlimeBes = $klass($base, $super, 'SlimeBes', $SlimeBes);

    var def = self.$$proto, $scope = self.$$scope, TMP_3;

    def.hp = def.atk = def.def = nil;
    return (def.$initialize = TMP_3 = function() {
      var $a, self = this, $iter = TMP_3.$$p, $yield = $iter || nil;

      TMP_3.$$p = null;
      Opal.find_super_dispatcher(self, 'initialize', TMP_3, null).apply(self, []);
      self.name = "スライムベス";
      $a = [self.hp.$to_i()['$*'](2), self.atk.$to_i()['$*'](2), self.def.$to_i()['$*'](2)], self.hp = $a[0], self.atk = $a[1], self.def = $a[2];
      return self.type2 = $scope.get('Pa').$new();
    }, nil) && 'initialize'
  })(self, $scope.get('Slime'));
  (function($base, $super) {
    function $Drakee(){};
    var self = $Drakee = $klass($base, $super, 'Drakee', $Drakee);
    ...
    return (def.$initialize = function() {
      ...
      self.atk = 6;
      self.def = 5;
      self.type = $scope.get('Cho').$new();
      return self.waza1 = $scope.get('Kirisaku').$new();
    }, nil) && 'initialize'
  })(self, $scope.get('Monster'));
  (function($base, $super) {
    function $Nyan(){};
    var self = $Nyan = $klass($base, $super, 'Nyan', $Nyan);
    ...
    return (def.$initialize = function() {
      ...
      self.atk = 3;
      self.def = 2;
      return self.type = $scope.get('Pa').$new();
    }, nil) && 'initialize'
  })(self, $scope.get('Monster'));
  Opal.Object.$$proto.$judge = function(j1, j2) {
    var $a, self = this;

    if ((($a = (j1['$=='](j2))) !== nil && (!$a.$$is_boolean || $a == true))) {
      return nil
    } else if ((($a = (j1['$==']("gu"))) !== nil && (!$a.$$is_boolean || $a == true))) {
      return j2['$==']("cho")
    } else if ((($a = (j1['$==']("cho"))) !== nil && (!$a.$$is_boolean || $a == true))) {
      return j2['$==']("pa")
    } else if ((($a = (j1['$==']("pa"))) !== nil && (!$a.$$is_boolean || $a == true))) {
      return j2['$==']("gu")
      } else {
      return nil
    };
  };
  s = $scope.get('Slime').$new();
  d = $scope.get('Drakee').$new();
  b = $scope.get('SlimeBes').$new();
  p = $scope.get('Nyan').$new();
  d.$show_status();
  s.$show_status();
  d.$waza1().$do(d, s);
  s.$waza1().$do(s, d);
